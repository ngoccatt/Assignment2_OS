...
//NUMBER OF PAGES THAT 1MB OF RAM HAVE: 2^10 PAGES
#define NUM_PAGES	(1 << (ADDRESS_SIZE - OFFSET_LEN))		//there are NUM_PAGES, each page has PAGE_SIZE.
//SIZE OF A PAGE, EQUAL 2^10 (1KB)
...
struct seg_table_t {
	...
	struct {
		...
		//this seg_table_t point to a page_table_t
